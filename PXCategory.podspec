#
#  Be sure to run `pod spec lint PXCategory.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Gpx"
  # s.authors            = { "Gpx" => "Gpxnslog@gamil.com" }
  # s.social_media_url   = "http://twitter.com/Gpx"
  ...
  s.public_header_files = 'PXCategory/PXCategory.h'
